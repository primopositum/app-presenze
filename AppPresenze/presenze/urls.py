...
api_urlpatterns = [
    ...
    path("jira/reference/get/", views.JiraReferenceGetView.as_view(), name="jira-reference-get"),
    path("jira/reference/add/", views.JiraReferenceAddView.as_view(), name="jira-reference-add"),
    path("jira/reference/put/", views.JiraReferencePutView.as_view(), name="jira-reference-put"),
    path("jira/reference/delete/", views.JiraReferenceDeleteView.as_view(), name="jira-reference-delete"),
